package com.example.fareed.lazeezo.Database;
...
public class Database extends SQLiteAssetHelper{
    private static final String DB_NAME="lazeezo.db";
    ...
    public boolean checkFoodExists(String foodId,String userPhone){
        ...
        if (cursor.getCount()>0){
            ...
            flag=false;
        cursor.close();
        Log.i("checkFood: ",String.valueOf(false));
        return flag;
    ...
    public void icreaseCart(String userPhone,String foodId){
        SQLiteDatabase db=getReadableDatabase();
    ...
    public void addToFavFood(String foodId,String userPhone){
        SQLiteDatabase db=getReadableDatabase();
    ...
    public void removeFavFood(String foodId,String userPhone){
        SQLiteDatabase db=getReadableDatabase();
    ...
    public boolean isFavFood(String foodId,String userPhone){
        SQLiteDatabase db=getReadableDatabase();
